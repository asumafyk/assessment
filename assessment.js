...
assessmentButton.addEventListener( //イベント検知をしたら実行される
  'click', //クリックイベント
  () => { //無名関数の記述方法
    const userName = userNameInput.value
     ...
     //headerDivisionの作成
      ...
      const anchor =document.createElement('a') //aタグを追加
      ...
      tweetDivision.appendChild(anchor) //div子要素として追加
...
userNameInput.addEventListener( //イベント検知の追加
  'keydown',
  (events) => {
    if (events.code === 'Enter') { //押されたキーがEnterなら
